...
export default {
  ...
  methods: {
    ...
    actualizarDashboard() {
      ...
      } else if (this.filtros.nivel === 'Inicial') {
        if (this.filtros.grado === '0') {
          this.tituloNotas = 'Promedio de Notas del Nivel Inicial';
          this.chartNotasNivel = {
            labels: ['3 años', '4 años', '5 años'],
            datasets: [{ label: 'Promedio', data: [14.5, 15.0, 15.8], backgroundColor: '#1976d2' }]
          };
        } else {
          this.tituloNotas = `Promedio de Notas - ${this.filtros.grado}`;
          const promedioPorGrado = {
            '3 años': 14.5,
            '4 años': 15.0,
            '5 años': 15.8
          };
          this.chartNotasNivel = {
            labels: [this.filtros.grado],
            datasets: [{ label: 'Promedio', data: [promedioPorGrado[this.filtros.grado] || 0], backgroundColor: '#1976d2' }]
          };
        }
      }
